...
parser.add_argument('--data_dir', default='data/science',
                    help="Directory containing the dataset")
parser.add_argument('--is_train', default='yes',
                    help="We want to test or to train model")
parser.add_argument('--model_dir', default='experiments/best_model_science',
...
if __name__ == '__main__':
    ...
    data = data_loader.load_data(['train', 'dev'], args.data_dir)
